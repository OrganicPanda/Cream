...
System.register("app/extract", ["npm:babel-runtime@4.7.16/core-js"], function (_export) {
  var _core;
...
System.register("app/main", ["npm:babel-runtime@4.7.16/core-js", "app/extract"], function (_export) {
  var _core, extract, textarea, statusEl, outputSuccess, outputError, handleFileSelect;

  return {
    setters: [function (_babelRuntimeCoreJs) {
      _core = _babelRuntimeCoreJs["default"];
    }, function (_appExtract) {
      extract = _appExtract["default"];
    }],
    execute: function () {
      "use strict";
      ...
      outputSuccess = function outputSuccess(statements) {
        textarea.innerHTML = statements.join("\r\n");
        statusEl.innerHTML = "Import successful!";
      };

      outputError = function outputError(err) {
      ...
      handleFileSelect = function handleFileSelect(evt) {
        ...
        _core.Promise.all(files.map(extract)).then(outputSuccess)["catch"](outputError);
      };
